...
class Lamina_Principal extends JPanel{
	...
	JButton boton_cerrar;// esta fuera por que opera dentro y fuera de esa clase puedes cerrar todas las ventanas
...
class Marco_Emergente extends JFrame{
	...
	public Marco_Emergente(JButton boton_principal){
		...
		setBounds(40*contador,30*contador,300,150);
