...
public class Tipos_Cuadors_dialogos {
	...
	private class Accion_botones implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource()==boton1){
				...
				JOptionPane.showMessageDialog(Lamina_Cuadros_Dialogos.this, "MENSAJE DE PRUEBA","Erros",0);
				...
				JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this, "Elige", "V opciones", 1, 1, null, null, null);
