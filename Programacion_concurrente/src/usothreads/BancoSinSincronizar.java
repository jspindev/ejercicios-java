...
public class BancoSinSincronizar {
	...
	public static void main(String[] args) {
		...
		for(int i=0;i<100;i++) {
			...
			EjecucionTransferencias r=new EjecucionTransferencias(b,i,200);
...
class Banco {
	...
	public synchronized void transferencia(int cuentaOrigen, int cuentaDestino,double cantidad) throws InterruptedException {
		...
		while(cuentas[cuentaOrigen]<cantidad) {   // evalua que el saldo no sea inferior a la transferencia antes era un if 
